...
1. Create a function called zooming_in that will generate a plot and 3 zoomed in versions.
...
1. Use zooming_in() to plot each of the 4 original functions.
...
1. Visualize these linearizations.
x <- seq(-5,5,1e-3)
