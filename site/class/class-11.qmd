...
1. Change these values as needed to compare plots. 
a1 <- 92
a2 <- 98
...
4. Update the parameters above to obtain a visual fit that satisfies $f_1(0)=100$.  Then use the https://shiny.byui.edu/connect/#/apps/0d605bec-7069-4d67-8129-8716269e8816/access to check your work. 
