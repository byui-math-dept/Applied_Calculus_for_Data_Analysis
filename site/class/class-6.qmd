...
Open https://byuistats.github.io/M119/project1.html#Task_2:_Models_and_Parameter_Exploration. There are 6 functions we'll be exploring.  Use the Desmos links provided there, and for each function spend time together as a group discussing how each parameter changes the behavior of the function. Write a description of what each parameter controls. 
