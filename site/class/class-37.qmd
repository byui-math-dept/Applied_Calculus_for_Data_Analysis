...
1. Let $g(x) = \sqrt{49-x^2}$ for $0\leq x\leq 7$ - use "
```r
g=Sqrt[49-x^2]@]". The region under $g(x)$ is a quarter of the circle $x^2+y^2=49$. You will see $\pi$ show up in lots of answers in Mathematica. Use "`%//N`" to approximate the output. 
