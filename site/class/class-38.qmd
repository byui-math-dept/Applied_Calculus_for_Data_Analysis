...
a <- 0
1. b should be infinity, but infinity is a concept (not a number) and the computer program needs a number to complete the calculation... so we pick a large but finite value for b
b <- 30 
n <- 1000
dx <- (b-a)/n
