...
title: "Class 31"
---
# Between Class Sessions - Prep for Day 31 <a id="tasklist"></a>
...
- Read [Second Derivative Test in Higher Dimensions](../assets/docs/SecondDerTest_BrianSittinger.pdf){target="_blank"}.
...
If the number of rows and columns of a matrix is the same we say the matrix is a square matrix.
    - Read [Section 9.8 Precalculus OpenStax text](https://openstax.org/books/precalculus/pages/9-8-solving-systems-with-cramers-rule){target="_blank"}. Focus on the sections Evaluate 2x2 determinants and Evaluate 3x3 determinants.
...
## Brain Gains
1. 
Any questions from [Second Derivative Test (Brian Sittinger, PDF)](../assets/docs/SecondDerTest_BrianSittinger.pdf)?  Any new terms you weren't sure what they meant?
...
*Source: [Class.31 on byuimath.com](https://byuimath.com/clarkc/all/119/index.php?n=Class.31)*
