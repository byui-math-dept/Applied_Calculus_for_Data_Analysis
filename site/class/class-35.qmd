...
1. Give the normalized target function by finding the constant $k$ so that the area under $f(x) = kg(x)$ is 1. 
1. Compute $P(X\leq 3)$. 
1. Calculate the expected value of $X$. Use this https://faculty.utrgv.edu/constantine.tarawneh/Fluid%20Mechanics/Centroid%20Locations.pdf.  
1. Give a formula for $F(x)$, the cumulative distribution function. 
1. Compute $F'(x)$. 
...
1. Find the area under $g$. Use this https://faculty.utrgv.edu/constantine.tarawneh/Fluid%20Mechanics/Centroid%20Locations.pdf.
1. Give the normalized target function by finding the constant $k$ so that the area under $f(x) = kg(x)$ is 1. 
1. Compute $P(X\leq 3)$. 
