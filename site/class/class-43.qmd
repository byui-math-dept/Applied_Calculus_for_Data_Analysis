...
title: "Class 43"
---
# Between Class Sessions - Prep for Day 43 <a id="tasklist"></a>
...
0 & \text{otherwise}
\end{cases},$$
determine whether each statement is true or false. Be prepared to share your reasoning with your group.
...
### (3) Continue working on Project 3
- Use your fitted models to calculate the required percentiles.
    - Write down the equations (each equation will include an integral).
    - Use Mathematica to solve the equations.

- For each of the fitted models calculate P(X<0).
    - How do these calculations help us determine if a model is consistent with what we know about Nitroglycerin concentrations?
...
We have discussed in class all the information you need to complete Project 3.
...
*Source: [Class.43 on byuimath.com](https://byuimath.com/clarkc/all/119/index.php?n=Class.43)*
